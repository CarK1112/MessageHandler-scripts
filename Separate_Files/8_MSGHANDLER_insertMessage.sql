...
|
|	Example: 
|   call insert_message('Object not found','Object BLA BLA not found','0', 'EN', NULL,@Code,@Text);
|
|
|---------------------------------------------------------------------------*/
...
BEGIN
   ...
   CASE out_execCode
        ...
        WHEN 1452 THEN
            SET out_execText = "insert_message: foreign key ERROR check if language exists!";
